...
import haq.app.thirdapp.databinding.FragmentArtTabBinding;
...
public class ArtTab extends Fragment implements PhotoAdapter.OnPhotoListner {

    FragmentArtTabBinding binding;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_art_tab, container, false);
    ...
    private void getPhotos() {
        MyDatabase.getInstance()
                .wallpaperDAO()
                .getPhotosetByID(Constants.ART_PHOTOSET_ID)
    ...
    private void setPhotos(List<PhotoDTO> list) {
        ...
        binding.rvArt.setLayoutManager(gridLayoutManager);
        binding.rvArt.setItemAnimator(new DefaultItemAnimator());
        binding.rvArt.setAdapter(adapter);
